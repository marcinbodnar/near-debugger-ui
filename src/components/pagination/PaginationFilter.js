...
const PaginationFilter = ({filterTypesByType, handleOnClick, dropdownType, handleDropdownClick, dropdown}) => (
   <PaginationFilterList horizontal className='border-right-light'>
      <List.Item>
         <Button
            ...
            style={{ backgroundImage: `url(${dropdownType}), url(${ArrowDown})` }}
         ></Button>

         <List selection verticalAlign='middle' className={`filter-dropdown ${dropdown ? '' : 'hide'}`}>
